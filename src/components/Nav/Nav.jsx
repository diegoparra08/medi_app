    ...
    return (
        <div>
            ...
            <img src={logo} alt="logo Med center" className="w-24 h-24 md:w-28 md:h-28" onClick={handleHomeClick} />
                ...
                <Link to='/book' className="text-customBlue font-bold">Agenda Tu Cita</Link>
                <Link to='/specialties' className="text-customBlue font-bold">Especialidades</Link>
                <Link to='/about' className="text-customBlue font-bold">Acerca de Nosotros</Link>
                <Link to='/login' className="text-customBlue font-bold">Log In</Link>
