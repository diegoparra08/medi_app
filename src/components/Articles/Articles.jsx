            ...
            >
                <div className="w-full">
                   ...
                   Recuerda que la vacunación de los niños es muy importante
                    ...
                    <p className="mb-[40px] max-w-full lg:h-44 xl:h-32 text-base font-medium rounded-md bg-white bg-opacity-30 p-2 text-customBlue5 md:w-[64%] lg:w-[72%] xl:w-[72%] 2xl:w-[60%] 3xl:w-[45%]">
